(function () {
    ...
    var Rollerblade = (function(){
        ...
        function Rollerblade(element, options) {
            ...
            _.settings = jQuery.extend(jQuery.fn.rollerblade.defaults, options);
            _.container = jQuery(element);
    ...
    jQuery.fn.rollerblade = function (options) {
        var instance;

        instance = this.data('rollerblade');
        if (!instance) {
            return this.each(function() {
                return jQuery(this).data('rollerblade', new Rollerblade(this, options));
            });
        }
    ...
    jQuery.fn.rollerblade.defaults = {
        imageArray : [],
        sensitivity: 35,
        drag : true,
        auto : false,
